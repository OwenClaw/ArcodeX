export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configured in arcodex.json",
  ...
  "error.chain.checkConfig": "Check your config (arcodex.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "ArcodeX includes free models so you can start immediately.",
