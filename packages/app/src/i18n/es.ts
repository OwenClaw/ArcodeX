export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados en arcodex.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (arcodex.json)",
