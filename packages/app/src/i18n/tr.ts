...
export const dict = {
  ...
  "dialog.plugins.empty": "Eklentiler arcodex.json içinde yapılandırılır",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (arcodex.json) sağlayıcı/model adlarını kontrol edin",
