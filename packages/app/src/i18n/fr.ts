export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurés dans arcodex.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (arcodex.json) pour les noms de fournisseur/modèle",
