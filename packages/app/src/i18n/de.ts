...
export const dict = {
  ...
  "dialog.plugins.empty": "In arcodex.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (arcodex.json) auf Anbieter-/Modellnamen",
