export const dict = {
  ...
  "dialog.plugins.empty": "Plugins configurados em arcodex.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (arcodex.json)",
