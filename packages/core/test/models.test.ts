...
// test/preload.ts pins ARCODEX_MODELS_PATH to a fixture so other tests can
...
// bun process.
const ORIGINAL_MODELS_PATH = Flag.ARCODEX_MODELS_PATH
const ORIGINAL_DISABLE_FETCH = Flag.ARCODEX_DISABLE_MODELS_FETCH
beforeAll(() => {
  Flag.ARCODEX_MODELS_PATH = undefined
  Flag.ARCODEX_DISABLE_MODELS_FETCH = true
})
afterAll(() => {
  Flag.ARCODEX_MODELS_PATH = ORIGINAL_MODELS_PATH
  Flag.ARCODEX_DISABLE_MODELS_FETCH = ORIGINAL_DISABLE_FETCH
})
