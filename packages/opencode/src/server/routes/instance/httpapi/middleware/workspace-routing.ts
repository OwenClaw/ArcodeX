...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.ARCODEX_WORKSPACE_ID ? WorkspaceID.make(Flag.ARCODEX_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-arcodex-directory"] || process.cwd()
}
