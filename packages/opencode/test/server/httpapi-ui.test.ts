  ...
  Effect.gen(function* () {
    ...
    yield* Effect.addFinalizer(() =>
      Effect.sync(() => {
        ...
        restoreEnv("ARCODEX_SERVER_PASSWORD", original.envPassword)
        restoreEnv("ARCODEX_SERVER_USERNAME", original.envUsername)
      }),
    )
  }),
)
      ...
      Layer.provide(
        ConfigProvider.layer(
          ConfigProvider.fromUnknown({
            ARCODEX_SERVER_PASSWORD: input?.password,
            ARCODEX_SERVER_USERNAME: input?.username,
          }),
        ),
      ),
    ),
