...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ARCODEX_CALLER", () => {
    process.env["ARCODEX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ARCODEX_CALLER", () => {
    process.env["ARCODEX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ARCODEX_CALLER", () => {
    process.env["ARCODEX_CALLER"] = "unknown"
