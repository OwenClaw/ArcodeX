...
const releaseId = process.env.ARCODEX_RELEASE
if (!releaseId) throw new Error("ARCODEX_RELEASE is required")

const version = process.env.ARCODEX_VERSION
if (!version) throw new Error("ARCODEX_VERSION is required")
